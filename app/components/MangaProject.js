...
const MangaProject = () => {
    ...
    return (
        <>
            <h3 className="text-lg font-semibold px-3 text-gray-800 dark:text-white py-3">Manga Project</h3>
            <div className="flex overflow-x-auto bg-white dark:bg-[#1F242D]">
                {
                    loading ?
                        <>
                        ...
                        komikList.map((komik, index) => (
                            <div className="p-4 w-[200px]" key={index}>
                                <Link href={`/pages/detail/${komik.link}`}>
                                    ...
                                    <h3 className="text-sm truncate text-ellipsis text-gray-500 dark:text-gray-400">{komik.chapter_update}</h3>
                                </Link>
                            </div>
                        ))
                }
